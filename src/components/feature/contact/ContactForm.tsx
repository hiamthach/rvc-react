    ...
    <div className="container py-10">
      <div className="flex flex-col md:flex-row w-full gap-5">
        <div className="flex-1">
          ...
          <h4 className="mt-10 mb-1 text-xl md:text-2xl leading-1">Công ty TNHH Rồng Vàng Capital</h4>
          <h5 className="mb-4 md:mb-10 mt-0 text-xl md:text-2xl leading-1 font-medium">RONG VANG CAPITAL COMPANY LTD.</h5>
        ...
        <div className="flex-1 shadow-lg rounded-3xl p-4 border border-solid border-[#f1f1f1]">
          <h4 className="home-section-hero text-primary text-center mb-4">Get in touch with us</h4>
