...
const AboutUsInformation = ({ content }: { content: Content }) => {
  ...
  return (
    <section className="container py-8 md:py-16">
      ...
      <h1 className="text-3xl leading-1 mt-2 mb-4 md:mb-8 font-extrabold">
        RỒNG VÀNG CAPITAL
      </h1>

      <Paragraph content={information?.description || ''} classNames="mb-10" />
      ...
      <div className="flex flex-col md:flex-row gap-4 md:gap-10 items-center">
        ...
        <div className="flex-1">
          <h3 className="home-section-hero text-primary uppercase text-right mb-1">
            {content.title}
          </h3>
          <h6 className="text-xl md:text-2xl uppercase text-right m-0 mb-4 md:mb-8">
            &quot;{content.subtitle}&quot;
          </h6>

          <Paragraph content={content.description} classNames="text-justify" />
        </div>
      </div>
    </section>
  );
